    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if (paymentAmount > remainingBalance) {
                throw new Error(
                    `Amount cannot exceed remaining balance of ₦${remainingBalance}`,
                );
            }
            ...
            const handler = window.PaystackPop?.setup({
                ...
                callback: function (response) {
                    console.log('Paystack callback response:', response); // Check this in F12 Console
                    ...
                    supabase.functions
                        .invoke('verify-paystack-payment', {
                            body: {
                                ...
                                due_id: due.id,
                                expectedAmount: Math.round(paymentAmount * 100), // in kobo
                            },
                        })
                        .then(({data, error}) => {
                            if (error) {
